...
namespace MultiPlayer.Player
{
    ...
    public class PlayerCamera : MonoBehaviour
    {
        ...
        [Space][SerializeField] private Vector2 _moveSensitivity = 10f * Vector2.one;

        [Space]
        [SerializeField] private Vector3 _firstPersonCameraOffset = new Vector3(0.0f, 0.0f, 0.1f);
        ...
        private void MoveAnchor()
        {
            ...
            Vector3 offset = _anchorOffset.x * Target.right + _anchorOffset.y * Target.up + _anchorOffset.z * Target.forward;
        ...
        private void MoveCamera(Perspective perspective)
        {
            ...
            void FirstPerson()
            {
                Camera.transform.localPosition = _firstPersonCameraOffset;
            }
        ...
        private void RotateCamera(Perspective perspective)
        {
            ...
            void ThirdPerson()
            {
                Vector3 forward = (transform.position - Camera.transform.position).normalized;
